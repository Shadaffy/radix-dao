...
>
> **Assumptions:** Same as the baseline roadmap. RAC members carry forward as founding Delegates. Consultation V2 is deployed. All 10 Phase 1 governance documents are drafted. The Founding Transferor begins preparing the IP Schedule in parallel from Day 1.
>
> **Target timeline:** 8–9 weeks to fully operational DAO with all Working Groups established and asset transfer executed (subject to Founding Transferor readiness on the IP Schedule).
...
**Everything else is flexible.** GP-1, GP-2, and GP-3 (the three post-registration bundles) have no dependency on each other — only on the entity existing.
...
- Draft the Entity Activation Package proposal (GP-1 — covers BOIR and operational policy adoption)
...
### Track D — Founding Transferor Parallel Workstream (Days 1 onward)

**Actor:** Founding Transferor (external); Compliance Liaison as liaison

The Founding Transferor begins preparing the IP Schedule (Exhibit A to the Asset Transfer Agreement) from Day 1. This is entirely on the Founding Transferor's side and is the one external dependency that cannot be internally accelerated.

The Compliance Liaison maintains weekly contact with the Founding Transferor to track progress and flag any asset classification questions early. The ATA terms should be negotiated and agreed in principle before entity registration — only the formal execution waits for the entity to exist.

**Founding Transferor deliverables needed by Day 36 (registration) to achieve the optimised timeline:**
...
This runs through the **community's own Consultation V2 deployment** — operated by the community independently of the Founding Transferor. The DAO does not yet legally exist as an entity, but the community already governs itself on-chain. This is the pre-registration founding act.
...
- Founding Transferor finalises IP Schedule based on any feedback from community during TC period

### During Governance Proposal Vote (Days 22–35): Do not wait

- Founding Transferor finalises and delivers completed IP Schedule to Compliance Liaison
...
Day 37  ──────────────────────────────────────────────── Day 57
  │                                                          │
  ├─ TC-1: Entity Activation Package ──────── Vote-1 ───────┤
  │  (GP-1: BOIR + policy adoption)                         │
  │                                                          │
  ├─ TC-2: Asset Transfer Authorization ───── Vote-2 ───────┤
  │  (GP-2)                                                  │
  │                                                          │
  └─ TC-3: All Working Groups ─────────────── Vote-3 ───────┘
     (GP-3: all five WGs bundled)
```

---

### Track 1 — Entity Activation Package (GP-1)
...
**Element 1 — File Initial BOIR:** Authorize Compliance Liaison to file the initial BOIR with MIDAO Directory Services. All Delegates (completed KYC in Phase 0) are listed as beneficial members under §702(r). Note: the BOIR must be filed within 30 days of formation per DAO Act §712(1). If the proposal timeline would exceed this, the Compliance Liaison files under RAC transitional authority on Day 36 and this vote serves as retrospective ratification.

**Element 2 — Adopt Operational Policies (OA §12.4):** Formally adopt all 10 Phase 1 governance documents as subordinate operational policies of Radix DLT DAO LLC. This gives the framework binding legal force under the Operating Agreement.

---

### Track 2 — Asset Transfer Authorization (GP-2)

**Type:** Constitutional
**Threshold:** ≥66% approval / ≥10% quorum
**TC:** Days 37–43 | **Vote:** Days 44–57

**Minimum community review period for the IP Schedule:** 14 days before the vote opens. Since the TC serves as the review window, the IP Schedule must be published on Day 37 alongside the TC. This is why the Founding Transferor's IP Schedule preparation in Phase 0 (Track D) is critical — it must be complete by Day 36.
...
- Legal Signatory and Founding Transferor execute Asset Transfer Agreement
...
### Track 3 — All Working Groups (GP-3)
...
|---|---|---|
| File BOIR with Registered Agent | Compliance Liaison | GP-1 (Track 1) passed |
| Operational policies formally in force | Governance Operator records | GP-1 (Track 1) passed |
| Founding Transferor authorization to release assets confirmed | Compliance Liaison verifies with Founding Transferor | GP-2 vote passed + Founding Transferor parallel process complete |
| ATA signed; IP Schedule accepted | Legal Signatory | GP-2 (Track 2) passed + Founding Transferor authorization confirmed |
| Continuity Statement executed and filed | Legal Signatory + Compliance Liaison | ATA signed |
| Acceptance Statement published | Legal Signatory | ATA executed |
| All 5 Working Groups operational | Each WG — Stewards confirmed | GP-3 (Track 3) passed |
| RAC interim execution authority lapses per workstream | Automatic | WG operational |
| RAC initiates treasury audit framework — scopes audit and brings auditor appointment proposal to governance | RAC | Phase 1 completion window; Treasury & Finance WG operational |
...
| Days | Action |
|---|---|
| 1–14 | Phase 0: KYC, technical setup, document prep, Founding Transferor IP Schedule — all parallel |
| 15–21 | GP-PRE-1 Temperature Check; formation documents finalised |
| 22–35 | GP-PRE-1 Vote; ATA finalised; Founding Transferor delivers IP Schedule |
...
**Total: ~8–9 weeks** (subject to Founding Transferor delivering IP Schedule by Day 36)
...
| Risk | Mitigation |
|---|---|
| Founding Transferor IP Schedule not ready by Day 36 | Start Founding Transferor workstream on Day 1; weekly check-ins from Compliance Liaison |
