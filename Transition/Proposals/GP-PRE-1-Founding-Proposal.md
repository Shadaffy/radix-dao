...
- [x] **Major** — Change to Charter, governance structure, or any body's authority or rights

This proposal creates the legal entity and governance structure from which all future authority flows. There is no more significant classification.
...
#### Element 2 — Entity Formation Authorization
...
**Smart contract identifiers to be confirmed and inserted before vote opens:**

| Identifier | Description | Value |
|---|---|---|
| `packageAddress` | Scrypto package identifier | [To be confirmed before TC opens] |
| `componentAddress` | Instantiated governance component | [To be confirmed before TC opens] |
| `adminBadgeAddress` | Owner Badge — used to elevate TCs to GPs | [To be confirmed before TC opens] |
...
**Inherent founding conflict:** The RAC members and founding Delegates named in Element 3 have a direct personal interest in being ratified by this vote. This conflict is inherent to any founding governance act and cannot be fully avoided. It is mitigated by: (a) the public nature of the ratification process; (b) the ability of token holders to exclude any specific appointment while still passing the entity formation and framework elements; and (c) the conditional appointment mechanism for any contested seat.

No RAC member may be the sole drafter of the Delegate roster without community review. The Delegate roster must be published as part of the Temperature Check, giving the community the full 7-day TC period to identify and raise concerns before the binding vote opens.
